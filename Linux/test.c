...
//testTypeMisMatch();
//testCollectiveOPTypeMismatch();

testDiffRanksCallSameMethod();

MPI_Barrier (MPI_COMM_WORLD);

testWait(); //testDiff...+testWait()=9.473s, Aug21:8.588s
...
//testDiffRanks...+testWait+testMulti2+testMultiSenderAndMultiRecver:12.285s, 
//9.687s_Aug23
//11.453s_Aug26

//9.213s_for_multiFiles+alltasks_after making the [0..N-1] 
//the single role before simu starts 
//9.27s for proc no= 15000
//testAllCollective();
